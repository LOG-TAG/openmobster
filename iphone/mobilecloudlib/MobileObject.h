...
@property (assign) NSString *service; //not-null
@property (assign) NSString *recordId; //not-null
@property (assign) NSString *serverRecordId;
@property (assign) BOOL proxy;
@property (assign) BOOL createdOnDevice;
@property (assign) BOOL locked;
@property (assign) NSString *dirtyStatus;
@property (assign) NSMutableArray *fields;
@property (assign) NSMutableArray *arrayMetaData;
