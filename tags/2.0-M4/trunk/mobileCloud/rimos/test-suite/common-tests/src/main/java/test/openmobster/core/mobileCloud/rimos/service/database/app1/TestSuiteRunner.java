...
import test.openmobster.core.mobileCloud.rimos.util.TestStringUtil;
...
{	
	...
	public void networkStarted(int networkId, int service) 
	{
		...
		{						
			...
			suite.addTest(new TestDatabase());
			suite.addTest(new TestStringUtil());
			suite.addTest(new TestAtomicity());
