...
SyncPlugin.prototype.test = function(tag,successCallback,errorCallback)
{
	return PhoneGap.exec(
		successCallback, //Success callback
		errorCallback, //Failure callback
...
SyncPlugin.prototype.addNewBean = function(channel,successCallback,errorCallback)
{
	return PhoneGap.exec(
		successCallback, //Success callback
		errorCallback, //Failure callback
...
SyncPlugin.prototype.updateBean = function(channel,oid,fieldUri,value,successCallback,errorCallback)
{
	return PhoneGap.exec(
		successCallback, //Success callback
		errorCallback, //Failure callback
