 ...
 */
public class RemoteCommandScreen extends Screen
{		
	private MainScreen screen;
	private boolean isRendered;
	
	public RemoteCommandScreen()
	{
	...
	{	
		if(!isRendered)
		{
			...
			this.screen.setTitle(appResources.localize(LocaleKeys.remoteCommand, LocaleKeys.remoteCommand));
