...
public final class Session 
{
	...
	public String getDataSource(boolean searchServerMessages)
	{
		...
		if(searchServerMessages)
		{
			...
			VectorUtil.addAll(allServerMessages, this.serverInitPackage.getMessages());
			VectorUtil.addAll(allServerMessages, this.serverSyncPackage.getMessages());			
		...
		else
		{
			...
			VectorUtil.addAll(allClientMessages,this.clientInitPackage.getMessages());
			VectorUtil.addAll(allClientMessages,this.clientSyncPackage.getMessages());
