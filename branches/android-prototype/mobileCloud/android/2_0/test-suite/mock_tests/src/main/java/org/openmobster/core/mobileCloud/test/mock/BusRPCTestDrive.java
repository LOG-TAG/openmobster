...
import org.openmobster.core.mobileCloud.test.service.testdrive.IBusRPC;

/**
 * @author openmobster
 *
 */
public class BusRPCTestDrive extends Test
{
	private IBusRPC remoteBus;
	...
	private void busConnect(Context context)
	{
		...
		busIntent.setClassName("org.openmobster.core.mobileCloud.test.service.testdrive", 
		"org.openmobster.core.mobileCloud.test.service.testdrive.BusRPC");		
	...
	private class BusConnection implements ServiceConnection
	{
		...
		{
			BusRPCTestDrive.this.remoteBus = IBusRPC.Stub.asInterface(binder);
		}

		public void onServiceDisconnected(ComponentName component)
		{	
			BusRPCTestDrive.this.remoteBus = null;
		}	
	}
}
