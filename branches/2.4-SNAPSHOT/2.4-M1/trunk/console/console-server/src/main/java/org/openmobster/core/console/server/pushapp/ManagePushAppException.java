 ...
 */
public class ManagePushAppException extends Exception
{	
	...
	public ManagePushAppException()
	{
		this("");
	}

	
	public ManagePushAppException(String msg)
	{
		super(msg);
	}

	
	public ManagePushAppException(Throwable t)
	{
		super(t.getMessage(), t);
	}
	
	public ManagePushAppException(int type)
	{
		this("");
		this.type = type;
	}
	
	public ManagePushAppException(String msg, int type)
	{
		this(msg);
		this.type = type;
	}
	
	public ManagePushAppException(Throwable t, int type)
	{
		this(t);
		this.type = type;
	}
