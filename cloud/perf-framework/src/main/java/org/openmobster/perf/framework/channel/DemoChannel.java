...
package org.openmobster.perf.framework.channel;
 ...
 */
@ChannelInfo(uri="perf_framework_demochannel", 
		   mobileBeanClass="org.openmobster.perf.framework.channel.DemoBean")
