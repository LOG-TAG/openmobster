	...
	public void registerDevice(String email, String activationCredential, String deviceIdentifier) throws IDMException
	{
		try
		{
			...
			else
			{
				...
				//log.info("---------------------------------------------------------------");
				//log.info("SubmittedIdentity Principal: "+email);
				//log.info("DeviceIdentity Principal: "+deviceIdentity.getPrincipal());
				//log.info("DeviceIdentity Credential: "+deviceIdentity.getCredential());
				//log.info("DeviceIdentity InactiveCredential: "+deviceIdentity.getInactiveCredential());
				//log.info("---------------------------------------------------------------");
				...
				//device.updateAttribute(new DeviceAttribute("nonce", deviceIdentity.getInactiveCredential()));
