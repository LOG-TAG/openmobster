...
mvn install:install-file -DgroupId=org.codehaus.mojo -DartifactId=exec-maven-plugin -Dversion=1.1.2-SNAPSHOT -Dpackaging=jar -Dfile=exec-maven-plugin-1.1.2-SNAPSHOT.jar
