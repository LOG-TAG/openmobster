...
import org.openmobster.titanium.module.TitaniumModuleModule;


/* WARNING: this code is generated for binding methods in Android */
public class TitaniumModuleModuleBindingGen
	extends org.appcelerator.kroll.KrollModuleBindingGen
{
	private static final String TAG = "TitaniumModuleModuleBindingGen";
	...
	public TitaniumModuleModuleBindingGen() {
		super();
		...
		if (name.equals(CREATE_Example)) {
			KrollBindingUtils.KrollProxyCreator creator = new KrollBindingUtils.KrollProxyCreator() {
				public KrollProxy create(TiContext context) {
					return new org.openmobster.titanium.module.ExampleProxy(context);
				}
			};
	...
	((TitaniumModuleModule) __invocation.getProxy()).getExampleProp(
);
	...
	((TitaniumModuleModule) __invocation.getProxy()).setExampleProp(
		value
		);
				}
			};
	...
	((TitaniumModuleModule) __invocation.getProxy()).example(
);
	...
	private static final String SHORT_API_NAME = "TitaniumModule";
	private static final String FULL_API_NAME = "TitaniumModule";
	private static final String ID = "org.openmobster.titanium.module";
	...
	public KrollModule newInstance(TiContext context) {
		return new TitaniumModuleModule(context);
	}

	public Class<? extends KrollProxy> getProxyClass() {
		return TitaniumModuleModule.class;
	}
