...
import org.bus.testdrive.errors.SystemException;
import org.bus.testdrive.storage.Database;
import org.bus.testdrive.storage.Record;
import org.bus.testdrive.util.ObjectShareUtil;
...
{			
	...
	{
		return (this.invocationThread != null);
	}
	//----------------------------------------------------------------------------------------------------------------------------------------
