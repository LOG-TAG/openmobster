...
public final class AppConfig 
{
	...
	//TODO: cleanup this configuration parsing code...its ugly!!
	public synchronized void init()
	{
		try
		{
			if(this.attrMgr == null)
			{
				...
				{
					registeredCommands.put("startup", 
							Class.forName("org.openmobster.core.mobileCloud.rim_native.framework.command.MobletBootstrapCommand").
							newInstance());
				}
