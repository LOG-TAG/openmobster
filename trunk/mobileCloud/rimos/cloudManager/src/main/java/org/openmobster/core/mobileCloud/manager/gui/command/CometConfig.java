...
public class CometConfig implements RemoteCommand
{
	...
	public void doViewBefore(CommandContext commandContext) 
	{
		...
		String mode = (String)commandContext.getAttribute("mode");
		
		if(mode.equals("poll"))
		{
			Object[] pollChoices = new Object[]{"5","10","15","20","25","30"}; 
			String pollLabel = resources.localize(LocaleKeys.poll_interval, LocaleKeys.poll_interval);
			int selected = Dialog.ask(pollLabel+": ", pollChoices, 2);
			
			int pollMinutes = Integer.parseInt((String)pollChoices[selected]);
