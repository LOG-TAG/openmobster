 ...
 *
 */
public final class MultiInvocationHandler implements InvocationHandler
{
	private String uri = null;
	private String data = null;
	
	public MultiInvocationHandler(String uri, String data)
	{
		this.uri = uri;
		this.data = data;
	}
	...
	public InvocationResponse handleInvocation(Invocation invocation)
	{
		...
		System.out.println("Successfully Invoked on ("+this.getClass().getName()+")---------------------------------------"+this.getUri());
