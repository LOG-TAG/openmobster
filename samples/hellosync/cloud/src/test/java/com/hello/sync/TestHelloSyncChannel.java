 ...
 */
public class TestHelloSyncChannel extends TestCase
{
	private static Logger log = Logger.getLogger(TestHelloSyncChannel.class);
	...
	public void setUp() throws Exception
	{
		...
		this.runner = (MobileBeanRunner)ServiceManager.locate("helloSyncRunner");
