 ...
 */
public class TestDataObjectChannel extends TestCase
{
	private static Logger log = Logger.getLogger(TestDataObjectChannel.class);
	...
	public void testBootUp() throws Exception
	{
		...
		for(MobileObject mobileObject: beans)
		{
			...
			{
				log.info("Field1: "+mobileObject.getValue("field1"));
				log.info("Field2: "+mobileObject.getValue("field2"));
				log.info("Field3: "+mobileObject.getValue("field3"));
				log.info("Field4: "+mobileObject.getValue("field4"));
			}
			log.info("-----------------------------------------------------------------");
		}
	}
